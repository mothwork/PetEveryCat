...
module.exports = {
  up: async (queryInterface, Sequelize) => {
   return await queryInterface.bulkInsert('Users', [
     ...
     { username: 'catlover2000',hashedPassword: bcrypt.hashSync('P@ssw0rd', 10),firstName: "Blake",lastName: "Kindly",bio: "I'm real but you'll never find me.",createdAt: new Date(),updatedAt: new Date()},
  ], {});
  },
